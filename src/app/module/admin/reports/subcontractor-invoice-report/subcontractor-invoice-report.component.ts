...
@Component({
  selector: 'app-subcontractor-invoice-report',
  templateUrl: './subcontractor-invoice-report.component.html',
  styleUrls: ['./subcontractor-invoice-report.component.css']
})
export class SubcontractorInvoiceReportComponent implements OnInit {
  ...
  constructor(
    ...
    this.captionChangeService.captionchangerSubject.next(CaptionConstants.SUBCONTRACTOR_INVOICE_REPORT);
