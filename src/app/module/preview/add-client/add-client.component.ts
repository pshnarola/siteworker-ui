...
export class AddClientComponent implements OnInit, OnDestroy {
  ...
  columns = [
    ...
    { label: 'Company Email', value: 'user_email', selected: true },
    { label: 'Work Phone', value: 'company_phone', selected: true },
    { label: 'Contact Name', value: 'contact_name', selected: true },
    { label: 'Contact Email', value: 'email', selected: false },
    { label: 'Mobile Phone', value: 'mobile_phone', selected: false },
    { label: 'Created Date', value: 'created_date', selected: false },
    { label: 'Email Verified?', value: 'is_verified', selected: false },
    { label: 'Status', value: 'is_active', selected: false }
  ];
  ...
  onLazyLoad(event): void {
    ...
    filterMap.set('PENDING_PROJECT_CLIENTS', 'id');
    const jsonObject = {};
  ...
  getContactName(name): void {
    ...
    this.filterLeftPanelService.getClientByContactNameForApprovalPendingAdmin(this.queryParam).subscribe(data => {
